  ...
  return (
    <div className=" h-full relative w-full my-20 flex flex-col lg:flex-row justify-center items-center ">
      <div>
        ...
        <div className="flex justify-center gap-20 py-4 text-center">
          <div>
      ...
      <div className="w-fit h-full  brightness-75  relative grid  overflow-hidden auto-rows-max gap-5 justify-items-center place-items-center grid-cols-3 ">
        <img
          className=" w-full md:w-full  rounded-lg shadow-md p-2 h-fit"
        ...
        />
        <img
          className=" w-full  row-span-3 rounded-lg shadow-md p-2 h-fit"
